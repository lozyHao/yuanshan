...
<template>
  <div class="work-space w-full h-full flex">
    ...
    <div class="space-box bg-color15 relative flex flex-col">
      ...
      <!-- 工作区 -->
      <div
        class="space default-layout w-full flex-1 p-4 overflow-y-auto flex-center flex-col relative"
      >
        <!-- 文件上传 -->
        <div
        ...
        >
          ...
          <n-spin
            v-show="preLoading"
            class="bg-opacity3-000 rounded-xl absolute top-0 left-0 z-10 w-full h-full"
            type="spinner"
            size="large"
          ></n-spin>
        </div>
    ...
    <image-detail
      v-model:show="showImageInfo"
      :exif="currentImageExif"
      :image="currentImage"
    ></image-detail>
  </div>
</template>
