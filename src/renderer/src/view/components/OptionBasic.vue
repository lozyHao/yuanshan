  ...
  <div class="option-basic pb-10">
    <n-grid x-gap="6" y-gap="16" :cols="7">
      ...
      <n-gi :span="2" class="flex-end">
        <n-space>
          <open-dir :iconSize="IconSize.Mini" :dir="formValue.outputPath"> </open-dir>
          <upload-file
      ...
      <n-gi :span="5" class="flex-start">
        <n-space>
          <img
            ...
            :class="[formValue.pattern === item.key ? 'border-#2080f0' : 'border-color15']"
      ...
      <n-gi class="flex-start" :span="5">
        <n-slider
          ...
          :min="50"
          :max="100"
          v-model:value="formValue.mainImgSize"
      ...
      <n-gi :span="5" class="flex-start">
        <n-switch
          size="small"
          v-model:value="formValue.textBgColorUsed"
      ...
      <n-gi :span="1" class="flex-between">
        <n-switch
          size="small"
          v-model:value="formValue.watermarkUsed"
      ...
      <n-gi class="flex flex-wrap justify-end" :span="1">
        <upload-file
          ...
          @on-change="handleChange(OptionBasicEnum.WATERMARK, $event)"
        ></upload-file>
        <div class="w-full my-1"></div>
        <camera-select
          @on-choose="handleChange(OptionBasicEnum.WATERMARK, $event)"
          :disabled="!formValue.watermarkUsed"
        ></camera-select>
      </n-gi>
      ...
      <n-gi :span="5" class="flex-start">
        <n-slider
          ...
          :min="0.05"
          :max="0.8"
          v-model:value="formValue.watermarkSize"
      ...
      <n-gi class="flex-start" :span="5">
        <n-slider
          ...
          :min="0"
          :max="50"
          v-model:value="formValue.roundedSize"
      ...
      <n-gi class="flex-start" :span="5">
        <n-slider
          ...
          :min="0"
          :max="1"
          v-model:value="formValue.shadowSize"
      ...
      <n-gi :span="5" class="flex-center">
        <n-switch
          size="small"
          v-model:value="formValue.bgColorUsed"
        ...
        <n-color-picker
          ...
          :modes="['hex']"
          :show-alpha="false"
          :disabled="!formValue.bgColorUsed"
          v-model:value="formValue.bgColor"
          @update:value="handleChange(OptionBasicEnum.BG_COLOR, $event)"
        />
      </n-gi>
      ...
      <n-gi class="flex-start" :span="5">
        <n-slider
          ...
          :min="0"
          :max="500"
          v-model:value="formValue.bgBlur"
      ...
      <n-gi :span="5" class="flex-center">
        <n-switch
          size="small"
          v-model:value="formValue.aspectRatioUsed"
      ...
      <n-gi :span="5">
        <n-slider
          ...
          :min="50"
          :max="100"
          v-model:value="formValue.outputQuality"
