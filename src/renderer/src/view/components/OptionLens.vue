...
import { OptionLensValues } from '@renderer/interfaces/options'

import PopLensEdit from '@renderer/components/PopLensEdit.vue'
...
<template>
  <div class="option-lens pl-3 pb-10">
    <n-grid x-gap="12" y-gap="8" :cols="1">
      ...
      <n-gi class="color9 flex-between text-base font-bold mb-2"> 相机参数 </n-gi>
      <n-gi
        class="flex-between bg-color15 rounded-lg p-1"
