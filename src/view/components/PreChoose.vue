...
<template>
	<div class="pre-choose w-full h-full rounded-lg overflow-hidden">
		<div class="flex-center bg-color15 w-full h-8">
			...
			<n-popover trigger="click" :show-arrow="false">
				...
				<div class="w-60 h-auto">
					<VueDraggable class="w-full cursor-pointer" v-model="options" :animation="150" @end="onUpdated">
						<div class="menu-hover flex-between p-1 rounded-md transition-colors cursor-pointer"
							...
							<n-button class="ml-2" strong secondary circle type="warning" size="tiny">
								<template #icon>
